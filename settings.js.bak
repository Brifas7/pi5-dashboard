...
const _themeColors={
  ...
  christmas:{rgb:'220,38,38',accent:'#dc2626',bg:'linear-gradient(to bottom, #1a0a0a 0%, #0f0505 40%, #0a1a0a 100%)',text:'#e0ffe8',sub:'#86efac',notif:'rgba(180,20,20,0.45)',overlay:'rgba(5,12,5,0.97)',gauge:'#dc2626',clock:'#f59e0b'},
